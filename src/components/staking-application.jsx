...
import PlrStakingBuilder from './staking/staking-flow';
      ...
      <section className="staking_application" id="application">
        <div className="container">
          <div className="staking_application__headline">
            <h2>
            This concludes the first PillarDAO staking pool. <br/> <span>We would like to thank everybody for participating. PLR and WETH rewards are returned on the Polygon chain. If you require assistance </span> moving PLR tokens and rewards from Polygon to Ethereum please <Link to="/unstaking-info"> follow&nbsp;the guide</Link> <span>.</span>
            </h2>
          </div>
